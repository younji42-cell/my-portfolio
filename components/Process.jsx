  ...
  const STEPS = [
    {
      ...
      images: [{ src: '/assets/ux-file.png', caption: 'UX정리 자료' },
      ],
    ...
    },
    {
      ...
      images: [{ src: '/assets/ui-img.png', caption: '메인 화면 시안' },
        // { src: '/assets/process-design-01.png', caption: '메인 화면 시안' },
        // { src: '/assets/process-design-02.png', caption: '모바일 반응형' },
      ],
    ...
    },
    {
      ...
      images: [{ src: '/assets/components.png', caption: '컴포넌트 라이브러리' },
        // { src: '/assets/process-system-01.png', caption: '토큰 구조' },
        // { src: '/assets/process-system-02.png', caption: '컴포넌트 라이브러리' },
      ],
    ...
    },
    {
      ...
      images: [
        // { src: '/assets/process-code-01.png', caption: '퍼블리싱 코드' },
      ],
